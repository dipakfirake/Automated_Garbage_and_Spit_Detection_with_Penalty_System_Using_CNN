...
image2 =image2.resize((1800,1000), Image.LANCZOS)
...
frame = tk.LabelFrame(window, text="", width=600, height=570, bd=5, font=('times', 14, ' bold '),bg="#bd95ab")
frame.grid(row=0, column=0, sticky='nw')
frame.place(x=450, y=150)

lbl = tk.Label(window, text="Registration Form", font=('times', 35,' bold '), height=2, width=65,bg="powder blue",fg="black")
lbl.place(x=0, y=0)
...
btn = tk.Button(frame, text="Register", bg="powder blue",font=("",20),fg="black", width=9, height=1, command=insert)
